...
CREATE TABLE Customer (Customer_Id INT PRIMARY KEY, First_name VARCHAR(40), Last_name VARCHAR(40),
    Email VARCHAR(100), Phone_no VARCHAR(10), Address VARCHAR(250), City VARCHAR(100), State VARCHAR(60),
    Zip_code VARCHAR(10),Country VARCHAR(80));
